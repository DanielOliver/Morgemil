...
let ``Test Vector2f Addition``() = 
  ...
  Assert.AreEqual(Vector2f(7.0, -3.0), vec1 + 2)
  Assert.AreEqual(Vector2f(7.0, -3.0), 2 + vec1)
  
[<Test>]
let ``Test Vector2f Subtraction``() = 
  Assert.AreEqual(Vector2f(9.0, -7.0), vec1 - vec2)
  Assert.AreEqual(Vector2f(3.0, -7.0), vec1 - 2)
  Assert.AreEqual(Vector2f(-3.0, 7.0), 2 - vec1)
  
[<Test>]
let ``Test Vector2f Multiplication``() = 
  Assert.AreEqual(Vector2f(-20.0, -10.0), vec1 * vec2)
  Assert.AreEqual(Vector2f(10.0, -10.0), vec1 * 2)
  Assert.AreEqual(Vector2f(10.0, -10.0), 2 * vec1)
  
[<Test>]
let ``Test Vector2f Division``() = 
  Assert.AreEqual(Vector2f(-1.0, -2.0), vec1 / vec2)
  Assert.AreEqual(Vector2f(2.0, -2.0), vec1 / 2)
